...
export const allBeginner: Step[] = [
  ...
  },
  {
    color: Color.Lanky,
    tag: Tag.Left,
    text: "W2, Trombone, ENTER Aztec 2"
  },
  {
    color: Color.Header,
    text: "--- AZTEC 2 ---"
  ...
  {
    color: Color.Header,
    text: "--- START SKEW - DON'T REGULAR JUMP!! ---"
  },
  {
    color: Color.Lanky,
