...
export const any5Kong: Step[] = [
  ...
  {
    color: Color.DK,
    text: "Pause exit, leave Japes Lobby"
  },
  {
    color: Color.DK,
    text: "Tag W3 in ring"
  ...
  {
    color: Color.DK,
    text: "Enter Caves, pause exit, leave"
  },
  {
    color: Color.DK,
  ...
  {
    color: Color.Diddy,
    text: "Pause exit, leave Lobby, W2, W4"
  },
  {
    color: Color.Lanky,
    text: "Factory Early"
  ...
  {
    color: Color.Tiny,
    text: "Enter Helm, kickslide up hills"
  },
  {
    color: Color.Chunky,
    tag: Tag.Right,
  ...
  {
    color: Color.Header,
    text: "See doc for K. Rool strategies"
  },
  ...krool
];
